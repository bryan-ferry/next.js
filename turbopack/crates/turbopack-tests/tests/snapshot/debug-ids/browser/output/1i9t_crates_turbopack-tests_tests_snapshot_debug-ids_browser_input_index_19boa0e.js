;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="e93f6e5b-02b8-4ab8-7f6d-e26aaa0df40c")}catch(e){}}();
 ...
 */ function loadComponentChunksOrWhole(sourceType, sourceData, componentChunks, chunkUrl) {
    ...
    const wholeChunkCached = unavailableCount > 0 && httpCachedChunks.has(chunkUrlToPath(chunkUrl));
...
/** Schedules a one-time idle pass that records (not loads) HTTP-cached manifest chunks. */ function scheduleChunkPreload() {
...
/** App-wide chunk list from `__TURBOPACK_CHUNK_PRELOAD_URL` (mixed URLs and paths); [] on failure. */ async function fetchChunkPreloadManifest() {
...
/** Whether chunk assets resolve to the document's origin (CHUNK_BASE_PATH may be a CDN URL). */ function chunkAssetsAreSameOrigin(g) {
    try {
...
//# debugId=e93f6e5b-02b8-4ab8-7f6d-e26aaa0df40c
